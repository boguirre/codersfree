<section class="mt-4">
    <h1 class="font-bold text-3xl mb-2 text-gray-800">Valoracion</h1>

    @can('enrolled', $course)
        <article class="mb-4">
            
            @can('valued', $course)
                <textarea wire:model="comment" class="form-control w-full" rows="3" placeholder="Ingrese un comentario"></textarea>
            ...
            @else
                ...
                <div class="flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                    ...
                    <p>Usted ya valoro este curso</p>
                </div>    
