<div class="container py-8">
        <x-table-responsive>
                ...
                <div class="px-6 py-4 flex">
                    <input wire:keydown="limpiar_page" wire:model="search" class="form-input flex-1 shadow-md" placeholder="Ingrese el nombre de un curso">
                ...
                @if ($courses->count())
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Calificacion</th>
