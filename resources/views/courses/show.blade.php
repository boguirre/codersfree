<x-app-layout>
    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="order-2 lg:col-span-2 lg:order-1">
            ...
            <section>
                <h1 class="font-bold text-3xl mb-2 text-gray-800">Descripcion</h1>
                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        @if ($course->price->value == 0)
                            <p class="text-2xl font-bold text-gray-500 mt-3 mb-4">Gratis</p>
                            <form action="{{route('courses.enrolled', $course)}}" method="POST">
                                @csrf
                                <button class="btn btn-danger btn-block" type="submit">Llevar este curso</button>
                            </form>
                        @else
                            <p class="text-2xl font-bold text-gray-500 mt-3 mb-4">US${{$course->price->value}}</p>
