    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-12">
        ...
        <div class="card text-gray-600">
            <div class="card-body">
                ...
                <hr>
                <p class="text-sm mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore labore laudantium ex. Molestias culpa placeat velit ullam, nisi autem ex recusandae doloribus maxime esse? Molestias officia inventore assumenda nulla ea.</p> <a href="" class="text-red-500 font-bold">Terminos y condiciones</a>
