<x-app-layout>
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                ...
                @else
                    <img class="h-60 w-full object-cover" src="https://images.pexels.com/photos/414628/pexels-photo-414628.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="">
                @endif
            </figure>
    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
            ...
            <section>
                <h1 class="font-bold text-3xl mb-2">Descripcion</h1>
        ...
        <div class="order-1 lg:order-2">
            <section class="card mb-4">
                <div class="card-body">
                    ...
                    <a href="{{route('admin.courses.observation', $course)}}" class="btn btn-danger w-full block text-center mt-4">Obervar Curso</a>
